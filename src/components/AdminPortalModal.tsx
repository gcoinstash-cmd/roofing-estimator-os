        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800 bg-[#0c0c0e]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-base text-zinc-200 leading-relaxed">Drone Measurement Engine, Pitch Multipliers &amp; Insurance Claims</p>
            </div>
          </div>
          <button
            onClick={onClose}
                    ...
                    {mockDroneScans.map((d) => (
                      <div key={d.id} className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                        <div className="space-y-1">
                          ...
                          <p className="text-base text-zinc-200 leading-relaxed">{d.damage}</p>
                        </div>
                        <div className="flex items-center gap-3">
                          <span className="text-xs font-mono text-zinc-400">{d.camera}</span>
                          <span className="px-2.5 py-1 rounded-full bg-emerald-950/60 text-emerald-400 border border-emerald-800 text-xs font-semibold tracking-wider font-mono uppercase">
                            {d.status}
                          </span>
                        </div>
                      </div>
